...
## Project Pillars
* [cite_start]**Hosts**: Real-time synchronized simulator engines using `simavr`. [cite: 1, 21]
* [cite_start]**Tools**: Custom hardware utilities like the automated smart-flashing tool. [cite: 23, 24]
* [cite_start]**Labs**: Modular exercises focusing on specific MCU features and reverse engineering workflows. [cite: 3, 7]
